...
const port = process.env.SERVER_PORT || process.env.PORT || 9300;        
const UUID = process.env.UUID || '18b4689a-59f8-41a5-8a6a-85d6365d497f'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cho11.joehy.us.kg';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiOGY5MTFhYmU5MDI3OTlmOGI0MjYzYTRmNTFhNTlmN2QiLCJ0IjoiMjY3NjllYWUtZGI3NS00NmE5LWE4OTUtYTJiNGFkOTg1ZGFiIiwicyI6IlltSXhPRFpqTmpRdE1ESmhNUzAwT1RZMExXRmhNekl0WVRJME16VTJNR0kwWkRkayJ9';
